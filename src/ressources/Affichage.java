...
public class Affichage {
	...
	public static void afficheTexteDansCase(int xCase, int yCase, String texte, Color couleur, double xInterne,
		...
		StdDraw.setPenColor(couleur);
		StdDraw.setFont(f);
		StdDraw.text(coordXCentreCase(xCase) + (xInterne - 0.4) * Config.largeurCaseX,
				coordYCentreCase(yCase) + (yInterne - 0.4) * Config.largeurCaseY, texte);
	}

	public static void afficheTexteDansCase(int xCase, int yCase, String texte, Color couleurTexte,
			Color couleurBackgroung, double xInterne, double yInterne, Font f) {
	...
	public static void afficheCercleDansCase(int xCase, int yCase, Color couleur, double xInterne, double yInterne) {
		StdDraw.setPenColor(couleur);
		StdDraw.filledCircle(coordXCentreCase(xCase) + (xInterne - 0.4) * Config.largeurCaseX,
				coordYCentreCase(yCase) + (yInterne - 0.4) * Config.largeurCaseY, 0.0150);
	}
	...
	public static void dessineRectangDansCase(int x, int y) {
		dessineRectanglePlein(coordXCentreCase(x) - Config.demiLargeurCaseX,
				coordXCentreCase(x) + Config.demiLargeurCaseX, coordYCentreCase(y) + Config.demiLargeurCaseY,
				coordYCentreCase(y) - Config.demiLargeurCaseY, Config.COULEUR_DEPLACEMENTS_POSSIBLE);
	}
